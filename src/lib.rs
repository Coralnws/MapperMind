...
#[derive(Debug)]
pub struct MapperMindProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MapperMindProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MapperMind processing");
    
    let mut processor = MapperMindProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MapperMindProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MapperMindProcessor::new(false);
